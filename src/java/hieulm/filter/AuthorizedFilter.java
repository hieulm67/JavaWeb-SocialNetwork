...
public class AuthorizedFilter implements Filter {
    ...
    static Logger log = Logger.getLogger(AuthorizedFilter.class.getName());
	...
	try {
	    ...
	    List<String> listMemberFunctions = (List<String>) context.getAttribute("LIST_MEMBER_FUNCTIONS");

	    boolean blockFuntions = false;
		...
		if (listMemberFunctions.contains(button) || listMemberFunctions.contains(resource)) {
